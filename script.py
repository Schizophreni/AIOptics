...
phase0 = (2 * np.pi * np.load("/Users/wuran/Downloads/python_forwardpropagation/python/256repeatto1024phase.npy")).astype(np.float32)
...
img = np.load("/Users/wuran/Downloads/inp_pred-9.npy")[0, 0] # [256, 256]
img = torch.from_numpy(img).clamp(0, 1.0) * 255
